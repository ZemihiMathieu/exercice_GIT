...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        cellar = new Room("in the cellar of the univeristy");
        
        // initialise room exits
        outside.setExits(null, theatre, lab, pub,null,cellar);
        ...
        cellar.setExits(null,null,null,null,outside,null);
    ...
    private void printWelcome()
    {
        ...
        currentRoom.affichageRoom(currentRoom);
        System.out.println();
    }
    ...
    private void goRoom(Command command) 
    {
        ...
        Room nextRoom = nextRoom = currentRoom.ChangeRoom(direction, currentRoom);
        if (nextRoom == null) {
